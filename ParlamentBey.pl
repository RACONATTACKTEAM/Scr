...
# // Coder By ParlamentBey# // Bu Script ParlamentBey Tarafından Kodlanmıştır.
# // ÇALANA HAKKIM HARAM OLSUN !
 
use Socket;
use strict;
 
if ($#ARGV != 3) {
  print "\e[96m Kullanım : perl ParlamentBey.pl ip port socket time\n";
  print "\e[91m     Coder By ParlamentBey\n";
  exit(1);
}
